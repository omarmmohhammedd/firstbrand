...
const SubCategoriesSlider = () => {
  ...
  useEffect(() => {
    axios
      .get(`${route}/api/v1/categories/6524b0d056f55f4760b86b96/subCategories`)
      .then((res) => {
    ...
    <div className="container mx-auto my-12 two">
      <h2 className="text-2xl my-8">
        {lang === "en"
          ...
          : "تسوق حسب العلامة التجارية المفضلة"}
      </h2>
              ...
              <div key={category?._id} className="px-2">
                ...
                >
                  <img
                    ...
                    className="aspect-square border border-slate-300 w-full h-full"
                    alt=""
                  />
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:grid-cols-3">
            {categories.map((category) => (
              <div key={category?._id} className="px-2">
                ...
                >
                  <img
                    className="aspect-square border-slate-300 w-full h-full"
                    src={category.imageCover}
                    alt=""
                  />
                  <div className="font-semibold bg-white rounded-full py-2 text-center shadow-sm border border-slate-200 absolute bottom-5 left-[50%] min-w-1/2 px-3 translate-x-[-50%]">
